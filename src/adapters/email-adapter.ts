...
export const emailAdapter = {
  ...
  async sendEmailConfirmationMessage(user: UserAccountDBType) {
    return await transporter.sendMail({
      ...
      <div><a style="font-size: 20px; text-decoration-line: underline" href=\"https://it-express-api.herokuapp.com/auth/registration-email-resend?Code=${user.emailConfirmation.confirmationCode}\"> Push to /registration-email-resend?Code= </a></div>
      `
    })
  },
