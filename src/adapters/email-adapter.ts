...
export const emailAdapter = {
  ...
  async sendEmailConfirmationMessage(user: UserAccountDBType) {
    return await transporter.sendMail({
      ...
      <div><a style="font-size: 20px; text-decoration-line: underline" href=\"https://it-express-api.herokuapp.com/auth/resend-registration-code/todo\"> Push to resend-registration-code </a></div>
      `
    })
  },
