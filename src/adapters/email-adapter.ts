...
export const emailAdapter = {
  ...
  async sendEmailConfirmationMessage(emailAndCode: UserEmailConfirmationCode) {
    return await transporter.sendMail({
      ...
      <div><a style="font-size: 20px; text-decoration-line: underline" href=\"https://it-express-api.herokuapp.com/auth/resend-registration-email?сode=${emailAndCode.confirmationCode}\"> Push to /resend-registration-emai?сode= </a></div>
      `
    })
  },
