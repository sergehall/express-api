  ...
  async sendEmailConfirmationMessage(emailAndCode: UserEmailConfirmationCode) {
    return await transporter.sendMail({
      ...
      <h1 style="color: dimgrey">Click on the link below to confirm your email address</h1>
       <div><a style="font-size: 20px; text-decoration-line: underline" href=\"https://it-express-api.herokuapp.com/auth/confirm-registration?code=${emailAndCode.confirmationCode}\"> Push to confirm. /registration-confirmation?code=... </a></div>
      ...
      <div><a style="font-size: 20px; text-decoration-line: underline" href=\"https://it-express-api.herokuapp.com/auth/resend-registration-email?сode=${emailAndCode.confirmationCode}\"> Push to /registration-email-resend?сode= </a></div>
      `
    })
  },
